...
//ruby folder
import {HomeRuby,RubyIntro,RubyFunc,RubyToken,RubyKey} from "./Content/Ruby/Ruby";
...
import IntroJava from "./Content/Java/IntroJava";
import TypesJava from "./Content/Java/TypesJava";
import StatementsJava from "./Content/Java/StatementsJava";
                ...
                <Switch>
                    ...
                    <Route path="/ruby"> 
                        ...
                        <Switch>
                            ...
                            <Route path="/ruby/keywords">
                                <RubyKey/>
                            </Route>
                            <Route path="/ruby/token">
                                <RubyToken/>
                            </Route>
                        </Switch>
                        <HomeRuby/>
                    ...
                    <Route path="/java"> 
                        ...
                        <Switch>
                            <Route path="/java/intro">
                                <IntroJava/>
                            </Route> 
                            <Route path="/java/token">
                                <TypesJava/>
                            </Route> 
                            <Route path="/java/statements">
                                <StatementsJava/>
                            </Route>               
                        </Switch>
                        <HomeJava/>
                 ...
                 {/************* React *************/}
                    ...
                    <Route path="/dsa"> 
                        ...
                        {/*  Sorting Algorithms */}
                            ...
                            <Route path="/dsa/sort/selection">
                                <DSASelectionSort/>
                            </Route>
                            <Route path="/dsa/sort/insertion">
                                <DSAInsertionSort/>
                            </Route>
                            <Route path="/dsa/sort/bubble">
                                <DSABubbleSort/>
                            </Route>
                            <Route path="/dsa/sort/merge">
                                <DSAMergeSort/>
                            </Route>
                            <Route path="/dsa/sort/quick">
                                <DSAQuickSort/>
                            </Route>
                            <Route path="/dsa/sort/shell">
                                <DSAShellSort/>
                            </Route>
                            <Route path="/dsa/sort/radix">
                                <DSARadixSort/>
                            </Route>
                            <Route path="/dsa/sort/counting">
                                <DSACountingSort/>
                            </Route>
                            <Route path="/dsa/sort/bucket">
                                <DSABucketSort/>
                            </Route>

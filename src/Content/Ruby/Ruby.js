...
function RubyIntro(props){
	...
	return (
		<>
			...
			<Head name="Example Code :"/>
			<Mark desc='tlp:codes 
				tlp:br
				# #!/bin/ruby tlp:br tlp:br
				tlp:cyan print tlp:yellow "Hello tlp:yellow World" tlp:br tlp:br
...
function RubyFunc(props){
	...
	return (
		<>
			...
			<Mark desc="The arguemnt will be decomposed if it responds to tlp:cyan to_ary method tlp:br tlp:br tlp:codes tlp:red def tlp:org my_method ((a, *b)) tlp:br tlp:tab p a: a, b: b tlp:br tlp:red end tlp:br my_method([1, 2, 3]) tlp:br # prints tlp:br {:a=>1,:b=>[2,3]} tlp:codee"/>
			...
			<Mark desc="Keyword arguments are similar to positional arguments with default values: tlp:br tlp:br tlp:codes tlp:red def tlp:org add_values (first: 1, second: 2) tlp:br tlp:tab first tlp:red + second tlp:br tlp:red end tlp:codee tlp:br Arbitrary keyword arguments will be accepted with tlp:red ** : tlp:br tlp:br tlp:codes tlp:red def tlp:org gather_arguments (first: nil, **rest) tlp:br tlp:tab tlp:cyan p first, rest tlp:br tlp:red end tlp:br gather_arguments first: 1, second: 2, third: 3 tlp:br # prints # 1 # then # {:second=>2, # :third=>3} tlp:codee"/>
...
function RubyKey(argument) {
	...
	return (
		<>
			<br/>
			<Navigator left="/ruby/intro" right="/ruby/token"/>
		</>
	);

}
function RubyToken(props){
	window.scrollTo(0,0)
	return (
		<>
			<br/>
...
export {HomeRuby,RubyIntro,RubyFunc,RubyToken,RubyKey}
